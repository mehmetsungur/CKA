# Hands-on Kubernetes-CKAD-13 : Kubernetes Pod Scheduling
  ...
  template:
    ...
    spec:
      ...
      - name: nginx
        ...
        ports:
        - containerPort: 80
      nodeName: minikube  #just add this line 
```
...
```bash
kubectl taint nodes minikube-m02 color=blue:NoSchedule
```
